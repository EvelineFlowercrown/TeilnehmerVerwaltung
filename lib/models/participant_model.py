...
#Start End Measure
#----------------------------------------------------------------------------------------------------------------------
    btz_start:Mapped[Date]= mapped_column(
        nullable = False
    )
    btz_ende:Mapped[Date] = mapped_column(
        nullable = False
    )
...
#Needs
#-----------------------------------------------------------------------------------------------------------------------
    gdb: Mapped[Boolean] = mapped_column(
        nullable = True
    )
    bvb:Mapped[Boolean] = mapped_column(
        nullable = True
    )
    ...
    table:Mapped[int] = mapped_column(
        nullable = True
    )
    #Enum for Measure
    class Measure(Enum)
